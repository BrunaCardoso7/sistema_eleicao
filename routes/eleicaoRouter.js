...
router.get('/:id/chapas/eleitores', chapasController.findAllChapasByEleitoresController)
...
router.get('/:id/:idchapa/candidatos/eleitores', chapasController.FindCandidatosInChapasFromEleitores)
